...
//                        REQUEST_PERMISSIONS);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if ((requestCode == REQUEST_GALLERY_IMAGE || requestCode == 101) && resultCode == RESULT_OK && data != null) {
            ...
            protected String doInBackground(Object... params) {
                try {
                    ...
                    VisionRequestInitializer requestInitializer =
                            new VisionRequestInitializer("AIzaSyCsa2DVBguCAS1nZYwynHfqudQLZAF3uRg") {
                                /**
                    ...
                    Vision vision = builder.setVisionRequestInitializer(requestInitializer).build();
